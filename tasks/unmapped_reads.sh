...
samtools cat -o $CWD/$SM/tmp/halfmapped.bam $CWD/$SM/tmp/halfmapped.f4F8.bam $CWD/$SM/tmp/halfmapped.f8F4.bam
samtools sort -m $(( MEM*1000/THREADS/100*90 ))M -@ $THREADS $CWD/$SM/tmp/halfmapped.bam > $CWD/$SM/bam/$SM.halfmap.bam
